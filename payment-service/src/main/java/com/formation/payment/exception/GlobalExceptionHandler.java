...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({PaymentNotFoundException.class, PaymentForBookingNotFoundException.class})
    ...
    public ResponseEntity<ApiError> handleConflict(PaymentNotRefundableException ex) {
